          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              ...
              <div className="flex items-center gap-3 text-xs text-white/80">
                ...
                <span>Gem Homes Advisory & Realtors (G.H.A.R.)</span>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4 bg-zinc-900/80 p-6 sm:p-8 rounded-3xl border border-white/10">
            {formSubmitted ? (
              ...
              <>
                ...
                <button 
                  type="submit" 
                  className="w-full py-3.5 bg-white text-black font-bold text-sm rounded-xl hover:bg-zinc-200 transition-colors shadow-lg cursor-pointer"
                >
                  Submit Inquiry
                </button>
              </>
